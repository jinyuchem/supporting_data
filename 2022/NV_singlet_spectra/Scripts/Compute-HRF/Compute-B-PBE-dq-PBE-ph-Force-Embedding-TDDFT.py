...
if __name__ == "__main__":
    ...
    f_phonon = '13824-1A1-phonon-cph-5-mesh.hdf5'

    f_force_gs = '1A1-F-at-1E-G-DFT.dat'
    f_force_es = '1A1-F-at-1E-G-TDDFT-full.dat'
    ...
    o_fname = 'All-B-1A1-1E-' + str(new_NVcell.noa) + '-rc2-' + str(radius_thres_2) + '-cph-5.dat'
