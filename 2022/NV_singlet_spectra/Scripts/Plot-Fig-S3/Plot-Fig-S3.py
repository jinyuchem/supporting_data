...
x_axis = np.linspace(-4,4,800)
y_axis = np.ones(x_axis.shape[0]) * anchor * 0
...
ax[0][0].plot(x_axis, path_e_ene, color=colors[0], label='')
ax[0][0].plot(x_axis, path_ep_ene, color=colors[1], label='')
ax[0][0].plot(x_axis, path_a_ene, color=colors[2], label='')
ax[0][0].plot(x_axis, ene_harmonic, color='black',
              linestyle='--', linewidth=0.5, label='')


ax[0][1].plot(x_axis, path_e_ene_pjt, color=colors[0], label='')
ax[0][1].plot(x_axis, path_ep_ene_pjt, color=colors[1], label='')
ax[0][1].plot(x_axis, path_a_ene_pjt, color=colors[2], label='')
ax[0][1].plot(x_axis, ene_harmonic, color='black',
              linestyle='--', linewidth=0.5, label='')


ax[0][2].plot(x_axis, path_e_ene_djt, color=colors[0],
              label='$|^1E_{low}\\rangle$')
ax[0][2].plot(x_axis, path_ep_ene_djt, color=colors[1],
              label='$|^1E_{high}\\rangle$')
ax[0][2].plot(x_axis, path_a_ene_djt, color=colors[2],
              label='$|^1A_1\\rangle$')
ax[0][2].plot(x_axis, ene_harmonic, color='black',
              linestyle='--', linewidth=0.5,
              label='harmonic')



ax[1][0].plot(x_axis, eigen_a[:,0], color=colors[2], linestyle='-')
ax[1][0].plot(x_axis, eigen_a[:,1], color=colors[2], linestyle='--')
ax[1][0].plot(x_axis, eigen_a[:,2], color=colors[2], linestyle=':')

ax[2][0].plot(x_axis, eigen_ep[:,0], color=colors[1], linestyle='-')
ax[2][0].plot(x_axis, eigen_ep[:,1], color=colors[1], linestyle='--')
ax[2][0].plot(x_axis, eigen_ep[:,2], color=colors[1], linestyle=':')

ax[3][0].plot(x_axis, eigen_e[:,0], color=colors[0], linestyle='-')
ax[3][0].plot(x_axis, eigen_e[:,1], color=colors[0], linestyle='--')
ax[3][0].plot(x_axis, eigen_e[:,2], color=colors[0], linestyle=':')
...
ax[1][1].plot(x_axis, eigen_a_pjt[:,0], color=colors[2], linestyle='-',
              label='$|\langle ^1A_1(Q) |^1A_1^{(0)} \\rangle|^2$')
ax[1][1].plot(x_axis, eigen_a_pjt[:,1], color=colors[2], linestyle='--',
              label='$|\langle ^1A_1(Q) |^1E_x^{(0)} \\rangle|^2$')
ax[1][1].plot(x_axis, eigen_a_pjt[:,2], color=colors[2], linestyle=':',
              label='$|\langle ^1A_1(Q) |^1E_y^{(0)} \\rangle|^2$')

ax[2][1].plot(x_axis, eigen_ep_pjt[:,0], color=colors[1], linestyle='-',
              label='$|\langle ^1E_{high}(Q) |^1A_1^{(0)} \\rangle|^2$')
ax[2][1].plot(x_axis, eigen_ep_pjt[:,1], color=colors[1], linestyle='--',
              label='$|\langle ^1E_{high}(Q) |^1E_x^{(0)} \\rangle|^2$')
ax[2][1].plot(x_axis, eigen_ep_pjt[:,2], color=colors[1], linestyle=':',
              label='$|\langle ^1E_{high}(Q) |^1E_y^{(0)} \\rangle|^2$')

ax[3][1].plot(x_axis, eigen_e_pjt[:,0], color=colors[0], linestyle='-',
              label='$|\langle ^1E_{low}(Q) |^1A_1^{(0)} \\rangle|^2$')
ax[3][1].plot(x_axis, eigen_e_pjt[:,1], color=colors[0], linestyle='--',
              label='$|\langle ^1E_{low}(Q) |^1E_x^{(0)} \\rangle|^2$')
ax[3][1].plot(x_axis, eigen_e_pjt[:,2], color=colors[0], linestyle=':',
...
ax[1][2].plot(x_axis, eigen_a_djt[:,0], color=colors[2], linestyle='-',
              label='$|\langle ^1A_1(Q) |^1A_1(0) \\rangle|^2$')
ax[1][2].plot(x_axis, eigen_a_djt[:,1], color=colors[2], linestyle='--',
              label='$|\langle ^1A_1(Q) |^1E_x(0) \\rangle|^2$')
ax[1][2].plot(x_axis, eigen_a_djt[:,2], color=colors[2], linestyle=':',
              label='$|\langle ^1A_1(Q) |^1E_y(0) \\rangle|^2$')

ax[2][2].plot(x_axis, eigen_ep_djt[:,0], color=colors[1], linestyle='-',
              label='$|\langle ^1E_{high}(Q) |^1A_1(0) \\rangle|^2$')
ax[2][2].plot(x_axis, eigen_ep_djt[:,1] - 0.0, color=colors[1], linestyle='--',
              label='$|\langle ^1E_{high}(Q) |^1E_x(0) \\rangle|^2$')
ax[2][2].plot(x_axis, eigen_ep_djt[:,2] + 0.0, color=colors[1], linestyle=':',
              label='$|\langle ^1E_{high}(Q) |^1E_y(0) \\rangle|^2$')

ax[3][2].plot(x_axis, eigen_e_djt[:,0], color=colors[0], linestyle='-',
              label='$|\langle ^1E_{low}(Q) |^1A_1(0) \\rangle|^2$')
ax[3][2].plot(x_axis, eigen_e_djt[:,1] - 0.0, color=colors[0], linestyle='--',
              label='$|\langle ^1E_{low}(Q) |^1E_x(0) \\rangle|^2$')
ax[3][2].plot(x_axis, eigen_e_djt[:,2] + 0.0, color=colors[0], linestyle=':',
              label='$|\langle ^1E_{low}(Q) |^1E_y(0) \\rangle|^2$')
...
ax[0][1].set_xlabel("$Q_\\alpha$ (amu$^{0.5}$ Å)")
ax[3][1].set_xlabel("$Q_\\alpha$ (amu$^{0.5}$ Å)")
