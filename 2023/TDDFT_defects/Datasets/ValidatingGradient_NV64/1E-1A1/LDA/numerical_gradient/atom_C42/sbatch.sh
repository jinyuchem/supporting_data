...
do
cd $i
mpirun -n 56 ${QEDIR}/pw.x -nb 2 < pw.in > pw.out
#mpirun -n 56 ${QEDIR}/wbse_init.x -ni 2 -i wbse_init.in > wbse_init.out
mpirun -n 56 ${QEDIR}/wbse.x -nb 2 -i wbse.in > wbse.out
cd ..
done
